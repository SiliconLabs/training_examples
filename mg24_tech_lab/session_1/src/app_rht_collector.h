...
#ifndef APP_RHT_COLLECTOR_H_
#define APP_RHT_COLLECTOR_H_
...
//                              Macros and Typedefs
// -----------------------------------------------------------------------------
#define RHT_SAMPLES_PER_CYCLE (1) // Number of samples required per request

// Data type for IMU acceleration and orientation vector data
typedef struct rht_sensor_data {
