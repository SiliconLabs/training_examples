 ...
 ******************************************************************************
 * Matter Button Occupancy Sensor - Training Example
 *
 ...
 *
 * The occupancy state is toggled by pressing the on-board button. 
 *
...
#define OUTPUT_OCCUPANCY LED_BUILTIN
#define INPUT_OCCUPANCY BTN_BUILTIN
...
void setup() {
  ...
  Serial.println("WW24 Button Matter Occupancy Sensor");
  ...
  // Setup inputs
  pinMode(INPUT_OCCUPANCY, INPUT_PULLUP);
  // Setup outputs
