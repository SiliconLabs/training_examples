...
#define PIXEL_MODE_COUNT 4           // Number of modes
...
uint8_t pixel_mode = PIXEL_MODE_GRADIENT_SHORT;                                        // Default display mode
uint16_t pixel_mode_led_masks[PIXEL_MODE_COUNT] = { 0b1, 0b101, 0b10101, 0b1010101 };  // LED flash patterns for each mode
